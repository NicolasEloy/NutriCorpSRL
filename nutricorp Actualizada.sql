...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-10-2023 a las 01:10:09
...
(2, 'Ensalada César', 'Lechuga, crutones, pollo a la parrilla, aderezo César', 456),
(3, '321313', 'fsfsf', 200),
...
(13, 'Dieta Proteica', 21, '2023-09-01', 75, 70, '2023-09-30'),
(14, 'Dieta Nutritiva', 22, '2023-08-15', 85.5, 80, '2023-09-15'),
(15, 'Dieta para Subir Peso', 23, '2023-09-10', 70, 65.5, '2023-10-10'),
(16, 'Dieta para Adelgazar', 24, '2023-08-20', 95, 90, '2023-09-30'),
(17, 'Dieta de Mantenimiento', 25, '2023-09-05', 80, 75, '2023-10-05'),
(18, 'Dieta Equilibrada', 26, '2023-08-10', 70.5, 67, '2023-09-10'),
(19, 'Dieta Vegetariana', 27, '2023-09-02', 88, 84.5, '2023-09-30'),
(20, 'Dieta Mediterránea', 28, '2023-08-25', 75, 70.5, '2023-09-25'),
(21, 'Dieta Atkins', 29, '2023-09-15', 90.5, 86, '2023-10-15'),
(22, 'Dieta Cetogénica', 30, '2023-08-12', 78, 74, '2023-09-12'),
(23, 'Dieta Paleolítica', 41, '2023-10-11', 124, 12, '2023-10-02');
...
(21, 'Juan ', 'Perez', 11111111, 'Calle 123, Ciudad A', 1234567890, '1990-01-15', 75, 1),
(22, 'Maria', 'Garcia', 22222222, 'Avenida XYZ, Ciudad B', 1234567891, '1985-05-20', 85, 1),
(23, 'Luis', 'Rodriguez', 33333333, 'Calle Principal, Ciudad C', 1234567892, '1978-12-10', 70, 1),
(24, 'Ana', 'Lopez', 44444444, 'Avenida Central, Ciudad D', 1234567893, '1992-08-30', 95, 1),
(25, 'Carlos Eduardo', 'Martínez', 55555555, 'Calle 456, Ciudad E', 1234567894, '1980-03-25', 80, 1),
(26, 'Laura Monica', 'Fernández', 66666666, 'Avenida ABC, Ciudad F', 1234567895, '1995-06-12', 70, 1),
(27, 'Pedro González', 'González', 77777777, 'Calle 789, Ciudad G', 1234567896, '1974-02-08', 88, 1),
(28, 'Sofía ', 'Díaz', 88888888, 'Avenida XYZ, Ciudad H', 1234567897, '1988-11-19', 75, 1),
(29, 'Miguel ', 'Pérez', 99999999, 'Calle 101, Ciudad I', 1234567898, '1987-07-05', 90, 1),
(30, 'dadada', 'Rodriguez', 10101010, 'Avenida Principal, Ciudad J', 1234567899, '1998-04-03', 32, 1),
(41, 'fadadnq', 'cadqad', 123, '234325252', 2147483647, '0000-00-00', 50, 1),
(42, 'dsgsgsg', 'sgssgs', 54353, 'gsgsg', 3242424, '0000-00-00', 143, 0),
(44, 'Jose', 'f23f2', 123456, '2f23f2f', 2, '0000-00-00', 13, 0),
(46, 'Jose', 'Martinez', 1212, 'afzfaqdbe1234', 12233525, '0000-00-00', 79, 0),
(47, 'Josse', 'Mdabdjad', 1234, 'dqdqdqjdakf2341', 123145242, '0000-00-00', 0, 1),
(49, 'Jose', 'Martinez', 12340, 'dadjj2ej2e2', 123421313, '0000-00-00', 80, 0);
...
--
ALTER TABLE `comida`
  MODIFY `IdComida` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
...
--
ALTER TABLE `dieta`
  MODIFY `IdDieta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT de la tabla `historialpeso`
--
ALTER TABLE `historialpeso`
  MODIFY `IdHistorialPeso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `paciente`
--
ALTER TABLE `paciente`
  MODIFY `IdPaciente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
